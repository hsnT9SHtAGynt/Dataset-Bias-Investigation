...
def load_aligned_resnet18(checkpoint_path: str, num_source_classes: int = 27):
    # 1. Read the original checkpoint
...
def parse_args(argv: List[str]):
    ...
    parser.add_argument("--checkpoint-in", default="D:/DeepLearning/Bias/User Files/ResNet18DatasetBias/Model Record/ResNet1804/best_uniform.pth", help="Pre trained backbone weights (27 class model 1804)")
    parser.add_argument("--checkpoint-out", default="best_Uniform_resnet18_datasetid_1804.pth", help="Where to save best fine tuned model")
